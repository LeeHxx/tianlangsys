            ...
            <div class="col-lg-8 mx-auto mt-4">
              <div class="card card-small mb-4">
                <div class="card-body p-0">
                  <form action="workshop-code-search_check.php" class="py-4" method="post">
                    <div class="form-row mx-4 ">
                      <div class="col  ">
                        <h5 class="form-text m-0">添加code</h5>
                    ...
                    <div class="form-row mx-4">
                      ...
                      <div class="form-group col-md-12">
                        ...
                        <div class="input-group mb-1">
                          ...
                          <input type="text" class="form-control is--valid" name="code_id" id="code_id" placeholder="输入订单号" value="<?php echo $_SESSION['order_id'] ?>">
            ...
            <div class="col-lg-8 mx-auto ">
              <div class="card card-small mb-4">
                <div class="card-body p-0">
                  <form action="workshop-code-add_check.php" class="py-4" id="workshop-code_add" method="post">
                    ...
                    <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name="code_get" id="code_get" placeholder="领料日期">
                      </div>
                      <div class="form-group col-md-6">                      
                      ...
                      <div class="form-group col-md-6">
                        ...
                        <input type="date" class="form-control" name=" code_end " id="code_end" placeholder="批次完成日期">
                      </div>
                      <div class="form-group col-md-6">
                        <label for=" code_turn_date ">转序日期</label>
                        <input type="date" class="form-control" name=" code_turn_date " id="code_turn_date" placeholder="转序日期">
                      </div>
                      <div class="form-group col-md-6">
                ...
                <div class="card-footer border-top ">
                  <div class="col">
                    <button id="btn2" form="workshop-code_add" class="btn  btn-accent mx-auto d-table mr-3"><i class="fa fa-check mr-1"></i>添加code</button>
                  </div>
                </div>
              </div>
            </div>
