				...
				<div class="main-content-container container-fluid px-4 mb-4">
					...
					<div class="page-header row no-gutters py-4">
						<div class="col-12 col-sm-4 text-center text-sm-left mb-4 mb-sm-0">
							...
							<h3 class="page-title">物料补领申请单</h3>
						</div>
              ...
              if(!$result)
{
  die('Could not connect:' .mysqli_error());
              ...
              for($i=0; $i<$loginNum; $i++){
                ...
                echo "<td>{$row['buliaoriqi']}</td>";
                echo "<td>{$row['buliaoxinghao']}</td>";
				echo "<td>{$row['buliaoshuliang']}</td>";
                echo "<td>{$row['shenqingzhe']}</td>";
                echo "<td>{$row['buliaoyuanyin']}</td>";
                echo "<td>{$row['zuzhangqueren']}</td>";
                echo "<td>{$row['wuliaodanjia']}</td>";
                echo "<td>{$row['wuguanyuanqueren']}</td>";
                echo "<td>
