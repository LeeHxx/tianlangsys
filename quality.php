              ...
              if(!$result)
{
  die('Could not connect:' .mysqli_error());
              ...
              for($i=0; $i<$loginNum; $i++){
                ...
                echo "<td>{$row['shoujiansongjainriqi']}</td>";
                echo "<td>{$row['shoujiansongjianzhe']}</td>";
				echo "<td>{$row['shoujianqueren']}</td>";
                echo "<td>{$row['picisongjianriqi']}</td>";
                echo "<td>{$row['songjianzhe']}</td>";
                echo "<td>{$row['hegeshu']}</td>";
                echo "<td>{$row['NGshu']}</td>";
                echo "<td>{$row['jianyanqueren']}</td>";
                echo "<td>{$row['jianyanquerenriqi']}</td>";
                echo "<td>
