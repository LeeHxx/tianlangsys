              ...
              if(!$result)
{
  die('Could not connect:' .mysqli_error());
              ...
              for($i=0; $i<$loginNum; $i++){
                ...
                echo "<td>{$row['fankuiriqi']}</td>";
                echo "<td>{$row['fankuizhe']}</td>";
				echo "<td>{$row['wentileixing']}</td>";
                echo "<td>{$row['wentimiaoshu']}</td>";
                echo "<td>{$row['yaoqiujiejueshijian']}</td>";
                echo "<td>{$row['jiejuecuoshi']}</td>";
                echo "<td>{$row['xiangguanzerenren']}</td>";
                echo "<td>
