...
$sql="UPDATE semi set semi_income='$income',semi_place='$place',semi_receive='$receive' WHERE id='$id'";
$result=mysqli_query($conn,$sql);

if($result){
    echo "<script>alert('修改成功！');window.location.href='warehouse-semi-add.php';</script>";
