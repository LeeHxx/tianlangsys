              ...
              if(!$result)
{
  die('Could not connect:' .mysqli_error());
              ...
              for($i=0; $i<$loginNum; $i++){
                ...
                echo "<td>{$row['jieliaoriqi']}</td>";
                echo "<td>{$row['jieshouzhe']}</td>";
				echo "<td>{$row['baozhuangriqi']}</td>";
                echo "<td>{$row['baozhuangzhe']}</td>";
                echo "<td>{$row['baozhuangshuliang']}</td>";
                echo "<td>{$row['chukuriqi']}</td>";
                echo "<td>{$row['chukuliang']}</td>";
                echo "<td>{$row['fahuozhe']}</td>";
                echo "<td>
