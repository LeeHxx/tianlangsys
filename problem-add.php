            ...
            <div class="col-lg-12 mx-auto ">
              <div class="card card-small mb-4">
                <div class="card-body p-0">
                  <form action="problem-add_check.php" class="py-4" id="problem_add0" method="post">
                    ...
                    <div class="form-row mx-4">
                      ...
                      <div class="form-group col-md-2">
                        <label for="solving_time">要求解决时间</label>
                          <input type="date" class="form-control" name="solving_time" id="solving_time" placeholder="要求解决时间">
                      </div>
                      <div class="form-group col-md-2">
                ...
                <div class="card-footer border-top ">
                  <div class="col">
                    <button id="btn2" form="problem_add0" class="btn  btn-accent mx-auto d-table mr-3"><i class="fa fa-check mr-1"></i>添加问题</button>
                  </div>
                </div>
              </div>
            </div>
