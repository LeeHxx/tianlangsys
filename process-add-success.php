      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="container-fluid px-0">
          <div class="alert alert-success alert-dismissible fade show m-0" role="alert">
            <strong>工艺信息</strong> 保存成功！<button type="button" class="close" data-dismiss="alert" aria-label="Close">
              ...
              <div class="card card-small mb-4">
                <form action="process-search_check.php" class="main-navbar__search w-100 " id="process_add" method="post">
                  <div class="input-group input-group-seamless ">
                    ...
                    <input class="navbar-search form-control ml-3" name="process_id" id="process_id" style="height:50px; border-radius:25px;" type="text" placeholder="请输入订单号..." aria-label="Search">
                  </div>
                </form>
              </div>
            </div>
