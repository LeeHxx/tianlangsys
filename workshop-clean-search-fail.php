              ...
              <div class="card card-small mb-4">
                ...
                <form action="workshop-clean-search_check.php" class="main-navbar__search w-100 " method="post">
                  <div class="input-group input-group-seamless ">
                    ...
                    <input class="navbar-search form-control ml-3" name="clean_id" id="clean_id" style="height:50px; border-radius:25px;" type="text" placeholder="请输入订单号..." aria-label="Search">
                  </div>
                </form>
