...
$sql="UPDATE dip set dip_get='$get',dip_recipient='$recipient',dip_readiness='$readiness',dip_first_start='$first_start',dip_first_opertor='$first_opertor',dip_batch_completion='$completion',dip_batch_end='$batch_end',dip_opertor='$opertor',dip_turn_date='$turn_date',dip_turn_volume='$volume'";
