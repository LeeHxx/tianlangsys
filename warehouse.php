              ...
              if(!$result)
{
  die('Could not connect:' .mysqli_error());
              ...
              for($i=0; $i<$loginNum; $i++){
                ...
                echo "<td>{$row['cunfanghuoweihao']}</td>";
                echo "<td>{$row['qitaozhuangtai']}</td>";
                echo "<td>{$row['youwuyuchuli']}</td>";
                echo "<td>{$row['kuguanyuan']}</td>";
                echo "<td>{$row['zhuanxubumen']}</td>";
                echo "<td>{$row['zhuanxuliang']}</td>";
                echo "<td>{$row['zhuanxuriqi']}</td>";
                echo "<td>{$row['zhuanxubanzu']}</td>";
                echo "<td>
