    ...
    <div class="row">
      ...
      <main class="main-content col-lg-10 col-md-9 col-sm-12 p-0 offset-lg-2 offset-md-3">
        ...
        <div class="main-content-container container-fluid px-4 mb-4">
          ...
          $sql0="select * from warehouse where order_id='$id' ";
              ...
              <div class="card card-small mb-4">
                <form action="warehouse-search_check.php" class="main-navbar__search w-100 " id="warehouse_add" method="post">
                  <div class="input-group input-group-seamless ">
                    ...
                    <input class="navbar-search form-control ml-3" name="w_id" id="w_id" style="height:50px; border-radius:25px;" type="text" placeholder="请输入订单号..." value="<?php echo $_SESSION['order_id'] ?>（已编辑）" aria-label="Search">
                  </div>
                </form>
              </div>
            </div>
            ...
            <div class="col-lg-12 mx-auto ">
              <div class="card card-small mb-4">
                <div class="card-body p-0">
                  <form action="warehouse-edit_check.php" class="py-4" id="warehouse_add0" method="post">
                    ...
                    <div class="form-row mx-4">
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="warehouse_place" id="warehouse_place" value="<?php echo $sql_arr0['warehouse_place'] ?>" placeholder="存放位置">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="warehouse_kitting">是否齐套</label>
                        <input type="text" class="form-control" name="warehouse_kitting" id="warehouse_kitting" value="<?php echo $sql_arr0['warehouse_kitting'] ?>" placeholder="是否齐套">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="warehouse_preprocessing">有无预处理</label>
                        <input type="text" class="form-control" name="warehouse_preprocessing" id="warehouse_preprocessing" value="<?php echo $sql_arr0['warehouse_preprocessing'] ?>" placeholder="有无预处理">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="warehouse_keeper">物管员</label>
                        <input type="text" class="form-control" name="warehouse_keeper" id="warehouse_keeper" value="<?php echo $sql_arr0['warehouse_keeper'] ?>" placeholder="物管员">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="warehouse_turn_department">转序部门</label>
                        <input type="text" class="form-control" name="warehouse_turn_department" id="warehouse_turn_department" value="<?php echo $sql_arr0['warehouse_turn_department'] ?>" placeholder="转序部门">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="warehouse_turn_volume">转序量</label>
                        <input type="number" class="form-control" name="warehouse_turn_volume" id="warehouse_turn_volume" value="<?php echo $sql_arr0['warehouse_turn_volume'] ?>" placeholder="转序量">
                      </div>
                      <div class="form-group col-md-3">
                        <label for="warehouse_turn_date">转序日期</label>
                        <div class="input-group with-addon-icon-left" >
                          <input type="text" data-provide="datepicker" class="form-control" name="warehouse_turn_date" id="warehouse_turn_date" value="<?php echo $sql_arr0['warehouse_turn_date'] ?>" placeholder="转序日期">
                      ...
                      <div class="form-group col-md-3">
                        ...
                        <input type="text" class="form-control" name="warehouse_turn_group" id="warehouse_turn_group" value="<?php echo $sql_arr0['warehouse_turn_group'] ?>" placeholder="转序班组">
                      </div>
                    </div>
                ...
                <div class="card-footer border-top ">
                  <div class="col">
                    <button id="btn2" form="warehouse_add0" class="btn  btn-info mx-auto d-table mr-3"><i class="fa fa-check mr-1"></i>保存仓库信息</button>
                  </div>
                </div>
              </div>
            </div>
